<main id="main-content" class="relative flex min-h-[calc(100dvh-4rem)] flex-col justify-center overflow-hidden">
    ...
    <div class="mx-auto max-w-5xl px-4">
        <div class="motion-preset-slide-up-lg mx-auto max-w-5xl px-4">
            <h1 class="mb-4 text-5xl font-bold tracking-tight text-balance text-stone-100 md:text-6xl">
                Hi, I'm
            ...
            <p class="mb-8 max-w-[52ch] text-lg text-pretty text-stone-300 md:text-xl">
            ...
            <div class="flex gap-6">
                <a
                    ...
                    class="group hover:text-accent-300 flex items-center gap-2 text-stone-400 transition-colors"
                    target="_blank"
