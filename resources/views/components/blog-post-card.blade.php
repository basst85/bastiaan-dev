...
<a
    class="blog-item block"
    href="{{ route('blogpost.show', $blogpost->slug) }}"
    data-pan="blogpost-{{ $blogpost->slug }}"
>
    <div
        class="card group shadow-card hover:border-accent-600/60 overflow-hidden rounded-xl border border-stone-800 bg-stone-800/30 p-1 transition-all duration-200 hover:-translate-y-1"
    >
